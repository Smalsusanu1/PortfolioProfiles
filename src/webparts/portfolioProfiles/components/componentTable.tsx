...
import { FaAngleDown, FaAngleUp, FaPrint, FaFileExcel, FaPaintBrush, FaEdit, FaSearch, FaRegTimesCircle, FaFilter } from 'react-icons/fa';
...
function ComponentTable({props}:any) {
