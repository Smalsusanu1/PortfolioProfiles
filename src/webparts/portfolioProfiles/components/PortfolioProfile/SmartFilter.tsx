...
const SmartFilter = () => {
    ...
    var selected2:any = [];
     const SingleLookDatatest = (item:any, value:any) => {
        ...
        if (item.Selected == false && selected2.length > 0) {
                                                                ...
                                                                <>
                                                                    <div style={{ display: "block" }}> {ItemType.Group == item &&
                                                                        <>
                                                                            ...
                                                                            <span className="plus-icon hreflink"onClick={() => handleOpen(ItemType)}>
                                                                                            {ItemType.childs.length > 0 &&
                                                                                                <a className='hreflink'
                                                                                                    title="Tap to expand the childs">
                                                                                                   {ItemType.show ? <img src="https://hhhhteams.sharepoint.com/sites/HHHH/SP/SiteCollectionImages/ICONS/24/list-icon.png" />
