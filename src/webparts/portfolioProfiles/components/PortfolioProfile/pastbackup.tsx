                                                                    ...
                                                                    <a className='hreflink'
                                                                        ...
                                                                        <span className="sign">{item.showk ? <img src="https://hhhhteams.sharepoint.com/sites/HHHH/SP/SiteCollectionImages/ICONS/24/right-list-icon.png" />
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <ul className="list-unstyled mb-0" style={{ fontWeight: "normal" }}>
                                                                                    <li
                                                                                        className="SiteCompositionlist">
                                                                                        <div className="SiteCompositionlist-SiteImage">
                                                                                            <img style={{ width: "22px" }} src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Shareweb/site_de.png" data-themekey="#" />
                                                                                        </div>
