...
function Portfolio({ ID }: any) {
    ...
    const handleOpen1 = (item: any) => {
      item.showl = item.showl == false ? true : false;
        setdatam(datam => ([...datam]));
    };
    const handleOpen2 = (item: any) => {
       item.shows = item.shows == false ? true : false;
        setdatas(datas => ([...datas]));
    };
    const handleOpen3 = (item: any) => {
        item.showk = item.showk == false ? true : false;
    ...
    {
        data.map(item => {
            if (item.Sitestagging != undefined)
                myarray = JSON.parse(item.Sitestagging);
            $.each(myarray, function (item: any, index) {
                if (item.SiteImages != undefined && item.SiteImages != '' && item.SiteImages.toLowerCase().indexOf('https://www.hochhuth-consulting.de/') > -1) {
                    item.SiteImages = item.SiteImages.replaceAll('https://www.hochhuth-consulting.de', 'https://hhhhteams.sharepoint.com/sites/HHHH')
                }
                if (item.ClienTimeDescription != undefined) {
                    item.ClienTimeDescription = parseFloat(item.ClienTimeDescription);
                    item.ClienTimeDescription = item.ClienTimeDescription.toFixed(2);
                }
            })
            $.each(myarray, function (item: any, index) {
                if (item.Title == 'Master Tasks' || item.Title == 'Small Projects' || item.Title == 'Foundation' || item.Title == 'Offshore Tasks' || item.Title == 'DRR' || item.Title == 'Health' || item.Title == 'Gender') {
    ...
    return (
                                            ...
                                            <div className="involve_actor">
                                                ...
                                                <div ng-show="Task.Portfolio_x0020_Type=='Component'"
                                                    ...
                                                    <div className="hreflink block ng-binding">
                                                        <a className="hreflink block ng-binding" target="_blank" href="https://hhhhteams.sharepoint.com/sites/HHHH/SP/SitePages/Portfolio-Profile.aspx?taskId=668">Integration of Distribution Lists</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
       ...
       <div className="panel panel-primary-head blocks"
           ...
           <div className="panel-heading profileboxclr"
                style= {{backgroundColor: "#f5f5f5",borderColor: "#ddd", padding: "7px"}}>
               <h3 className="panel-title" style={{textAlign: "inherit"}}>
                   <label htmlFor="identifier-3" className="lbltitleclr">
                       Site
                       Composition
                   </label>
                   <a ng-if="isMemberOwner==true" className="hreflink"
                      title="Analyse Site Composition"
                      ng-click="EditSiteCompositionTask(Task)">
                       <img className="wid-20"
                            src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/32/analyze.png"/>
                    {data.map(item=>
                   <span className="pull-left" >
                   <span className="sign"  onClick={() => handleOpen3(item)}>{item.showk ? <img src="https://hhhhteams.sharepoint.com/sites/HHHH/SP/SiteCollectionImages/ICONS/24/right-list-icon.png" />
           ...
           <div
               ...
               <ul className="list-unstyled mb-0">
                   <li ng-repeat="item in SiteComposition | orderBy:orderBy1:revers"
                       className="SiteCompositionlist">

                       <div className="SiteCompositionlist-SiteImage">
                           <img style={{width:"22px"}} src={item.SiteImages}/>
                           {/* <!--{{item.Title}}--> */}
                       </div>
                       <span>
                       {item.Title=='EPS' &&
                      myarray2.map((client: any)=>{
                       <div
                       ...
                       <div className="SiteCompositionlist-ClienTimeDescription">
                           <span ng-show="item.ClienTimeDescription!=undefined && item.Title!='Health' && item.Title!='Gender'">
                               ...
                               <div ng-show="client.siteName=='EI'"
                                   ...
                                   <span>
                                     {client.Title} 
                                                        ...
                                                        {/* {myarray.length!=0?myarray[0].map((items: any)=><a>{items.Title}</a>):""} */}
                                                                            ...
                                                                            <span className="sign">{item.show ? <img src="https://hhhhteams.sharepoint.com/sites/HHHH/SP/SiteCollectionImages/ICONS/24/right-list-icon.png" />
                                                                             ...
                                                                             <div>
                                                                                    <div className="boxbdrdesign" id="testDiv1">
                                                                                        <span className="ng-binding"> {data.map(items => <a>{items.Short_x0020_Description_x0020_On}</a>)} </span>
                                                                                    </div>
...
<div>
<li ng-repeat="item in SiteComposition | orderBy:orderBy1:revers" className="SiteCompositionlist ng-scope">
                                                                                        <div className="SiteCompositionlist-SiteImage">
                                                                                            <img style={{ width: "22px" }} src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Shareweb/site_ei.png" data-themekey="#" />
                                                                                        </div>
                                                                                        <div className="SiteCompositionlist-ClienTimeDescription">
                                                                                            <span ng-show="item.ClienTimeDescription!=undefined &amp;&amp; item.Title!='Health' &amp;&amp; item.Title!='Gender'" className="ng-binding">
                                                                                                30%
                                                                                            </span>
                                                                                            <span className="ng-binding"> Kontakt Verwaltung </span>
                                                                                        </div>
                                                                                    </li>
                                                                                    <li ng-repeat="item in SiteComposition | orderBy:orderBy1:revers" className="SiteCompositionlist ng-scope">
                                                                                        <div className="SiteCompositionlist-SiteImage">
                                                                                            <img style={{ width: "22px" }} src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Shareweb/site_eps.png" data-themekey="#" />
                                                                                        </div>
                                                                                        <div className="SiteCompositionlist-ClienTimeDescription">
                                                                                            <span ng-show="item.ClienTimeDescription!=undefined &amp;&amp; item.Title!='Health' &amp;&amp; item.Title!='Gender'" className="ng-binding">
                                                                                                40%
                                                                                            </span>
                                                                                            <span className="ng-binding"> Nutzer Verwaltung </span>
                                                                                        </div>
                                                                                    </li>
                                                                                    <li ng-repeat="item in SiteComposition | orderBy:orderBy1:revers" className="SiteCompositionlist ng-scope">
                                                                                        <div className="SiteCompositionlist-SiteImage">
                                                                                            <img style={{ width: "22px" }} src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Shareweb/site_qa.png" data-themekey="#" />
                                                                                        </div>
                                                                                        <div className="SiteCompositionlist-ClienTimeDescription">
                                                                                            <span ng-show="item.ClienTimeDescription!=undefined &amp;&amp; item.Title!='Health' &amp;&amp; item.Title!='Gender'" className="ng-binding">
                                                                                                10%
                                                                                    ...
                                                                                    <li ng-repeat="item in SiteComposition | orderBy:orderBy1:revers" className="SiteCompositionlist ng-scope">
                                                                                        <div className="SiteCompositionlist-SiteImage">
                                                                                            <img style={{ width: "22px" }} src="https://hhhhteams.sharepoint.com/sites/HHHH/SiteCollectionImages/ICONS/Shareweb/site_migration.png" data-themekey="#" />
                                                                                        </div>
                                                                                        <div className="SiteCompositionlist-ClienTimeDescription">
                                                                                            <span ng-show="item.ClienTimeDescription!=undefined &amp;&amp; item.Title!='Health' &amp;&amp; item.Title!='Gender'" className="ng-binding">
                                                                                            </span>
